...
public class CopyPastePose : MonoBehaviour
{
	...
	#if UNITY_EDITOR 
	[MenuItem("Window/Animation/Copy Pose")]
	...
	[MenuItem("Window/Animation/Copy Pose", true)]
	static bool ValidateCopyPose() {
		return Selection.activeTransform != null;
	}
   
	[MenuItem("Window/Animation/Paste Pose")]
	...
	[MenuItem("Window/Animation/Paste Pose", true)]
