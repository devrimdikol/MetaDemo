...
public class RigidBodyTargeter : MonoBehaviour
{
	...
	public float aproachDistance=3f;
	...
	private void FixedUpdate()
	{
		...
		if ( distance<aproachDistance)
			rot = target.rotation;
		// Torque
			Vector3 torque = PhysXTools.GetAngularAcceleration(r.rotation, rot);
