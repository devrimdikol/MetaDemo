...
Shader "RRF_HumanShaders/HairShader2/HairShader2_AS_RRF_VRTC_URP_2021"
{
	Properties
	{
		...
		_FakeOccAdj("FakeOccAdj", Range( 0 , 1)) = 0
		_FakeOccPower("FakeOccPower", Range( 0 , 3)) = 0
		...
		_Soften("Soften", Range( 0 , 0.005)) = 0
		...
		_NoisePowerX("NoisePowerX", Range( 0 , 2000)) = 0
		_NoisePowerY("NoisePowerY", Range( 0 , 2000)) = 0
		...
		[ASEEnd]_DitherAmount("DitherAmount", Range( 0 , 1)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_VRTC = IN.ase_texcoord7.xy * _VRTC_ST.xy + _VRTC_ST.zw;
				float4 tex2DNode335 = tex2D( _VRTC, uv_VRTC, float2( 0,0 ), float2( 0,0 ) );
				...
				float2 temp_cast_1 = (_Soften).xx;
				float2 temp_cast_2 = (_Soften).xx;
				float3 unpack7 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap, temp_cast_1, temp_cast_2 ), _BumpPower );
				unpack7.z = lerp( 1, unpack7.z, saturate(_BumpPower) );
				float3 tex2DNode7 = unpack7;
				float originalAlphaCutout403 = tex2DNode335.a;
				float2 appendResult365 = (float2(_NoisePowerX , _NoisePowerY));
				...
				float3 break459 = OUTPUT_NormalMap410;
				float lerpResult461 = lerp( break459.y , break459.z , _FakeOccAdj);
				float3 temp_cast_7 = (lerpResult461).xxx;
				float clampResult468 = clamp( _FakeOccPower , 0.0 , 1.0 );
				float temp_output_2_0_g11 = clampResult468;
				...
				float3 temp_output_467_0 = ( ( temp_cast_7 * temp_output_2_0_g11 ) + appendResult7_g11 );
				float fresnelNdotV473 = dot( SafeNormalize(_MainLightPosition.xyz), WorldViewDirection );
				float fresnelNode473 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV473, 5.0 ) );
				float clampResult480 = clamp( fresnelNode473 , 0.0 , 1.0 );
				...
				float clampResult470 = clamp( ( ( ( dotResult346 + _Light_Bias ) * _Light_Scale ) * _LightScatter ) , 0.0 , 1.0 );
				float SSS_Effect394 = clampResult470;
				float4 lerpResult339 = lerp( ( temp_output_268_0 + temp_output_265_0 ) , OUTPUT_Albedo407 , SSS_Effect394);
				float4 lerpResult471 = lerp( lerpResult339 , OUTPUT_Albedo407 , _BaseIllumination);
				float4 OUTPUT_Emissive398 = ( ( clampResult480 * OUTPUT_Albedo407 ) + lerpResult471 );
				...
				float dither454 = Dither8x8Bayer( fmod(clipScreen454.x, 8), fmod(clipScreen454.y, 8) );
				dither454 = step( dither454, OUTPUT_HairOpacity388 );
				float lerpResult456 = lerp( OUTPUT_HairOpacity388 , dither454 , _DitherAmount);
				
				float3 Albedo = OUTPUT_Albedo407.rgb;
				float3 Normal = OUTPUT_NormalMap410;
				float3 Emission = ( float4( temp_output_467_0 , 0.0 ) * OUTPUT_Emissive398 ).rgb;
				float3 Specular = 0.5;
				float Metallic = _Metallic;
				float Smoothness = OUTPUT_Smothness412;
				float Occlusion = temp_output_467_0.x;
				float Alpha = lerpResult456;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 appendResult7_g11 = (float3(temp_output_3_0_g11 , temp_output_3_0_g11 , temp_output_3_0_g11));
				float3 temp_output_467_0 = ( ( temp_cast_7 * temp_output_2_0_g11 ) + appendResult7_g11 );
				float fresnelNdotV473 = dot( SafeNormalize(_MainLightPosition.xyz), ase_worldViewDir );
				float fresnelNode473 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV473, 5.0 ) );
				float clampResult480 = clamp( fresnelNode473 , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18712
1159.333;514;1370.667;874.3334;3408.461;637.9438;1.931866;True;False
Node;AmplifyShaderEditor.CommentaryNode;402;-632.5151,280.1337;Inherit;False;1958.913;736.6984;Comment;16;311;390;384;364;365;316;315;300;307;299;114;7;404;410;458;484;Noise and Normal Map;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;406;-3766.658,-1337.893;Inherit;False;3050.46;2470.514;Comment;69;392;331;328;372;329;403;335;267;314;109;264;261;108;260;259;106;286;258;104;107;105;262;326;327;102;257;285;290;256;103;97;396;373;370;289;255;132;371;134;368;254;253;99;98;252;249;94;95;251;248;96;247;200;93;246;245;78;241;77;243;17;305;304;306;268;397;265;292;330;Color and Highlight Mixing;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;364;-601.5151,845.101;Float;False;Property;_NoisePowerX;NoisePowerX;28;0;Create;True;0;0;0;False;0;False;0;749;0;2000;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;458;-606.4874,930.3204;Float;False;Property;_NoisePowerY;NoisePowerY;29;0;Create;True;0;0;0;False;0;False;0;299;0;2000;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;335;-2762.142,-606.1206;Inherit;True;Property;_VRTC;VRTC;8;0;Create;True;0;0;0;False;0;False;-1;None;943f10e40206aad488ec3d968d99ccf6;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;485;-501.8691,530.431;Inherit;False;Property;_Soften;Soften;17;0;Create;True;0;0;0;False;0;False;0;0.00073;0;0.005;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-512.2765,424.4365;Float;False;Property;_BumpPower;BumpPower;16;0;Create;True;0;0;0;False;0;False;0.5;2.84;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;300;-537.5021,693.4656;Float;False;Property;_Spread;Spread;27;0;Create;True;0;0;0;False;0;False;0;0.749;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;315;170.1231,852.1289;Inherit;False;Simplex2D;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;7;-73.77025,365.0654;Inherit;True;Property;_NormalMap;NormalMap;6;0;Create;True;0;0;0;False;0;False;-1;cf24829a9bef4734582a302bd6f6d130;c206cbb707a05de41a95b94e0b30e342;True;0;True;bump;Auto;True;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;303;-4666.173,-818.6374;Float;False;Property;_MainHighlightPosition;Main Highlight Position;20;0;Create;True;0;0;0;False;0;False;0;0.01;-1;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;244;-3992.72,-1179.694;Float;False;Property;_SecondaryHighlightPosition;Secondary Highlight Position;24;0;Create;True;0;0;0;False;0;False;0;0.8;-1;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;384;715.2823,694.3094;Float;False;Property;_XTiling;XTiling;32;0;Create;True;0;0;0;False;0;False;0;1.2;1;8;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;371;-2728.873,-294.687;Float;False;Property;_VRTC_Scale;VRTC_Scale;11;0;Create;True;0;0;0;False;0;False;1;0.93;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;254;-2533.547,500.5397;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;380;1379.835,734.2379;Float;False;Property;_Stretch;Stretch;31;0;Create;True;0;0;0;False;0;False;0.4961396;0.4961396;0.01;1.01;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;368;-2729.725,-381.3201;Float;False;Property;_VRTC_Bias;VRTC_Bias;10;0;Create;True;0;0;0;False;0;False;0;0.745;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;383;1379.368,821.2239;Float;False;Constant;_Adjust;Adjust;29;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;396;-2091.989,-289.3039;Float;False;Property;_Alpha_Level;Alpha_Level;7;0;Create;True;0;0;0;False;0;False;1;1.24;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;373;-1935.277,-600.7404;Float;False;Property;_UseVRTC_BiasAndScale;UseVRTC_BiasAndScale?;9;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.PowerNode;391;1856.224,767.3331;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;329;-2045.256,-1287.893;Float;False;Property;_RootColorPowerA;RootColor-Power(A);14;0;Create;True;0;0;0;False;0;False;0.1102941,0.1005623,0.1005623,0.453;0,0,0,0.9843137;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;107;-2597.844,129.8814;Float;False;Property;_MainHighlightExponent;Main Highlight Exponent;22;0;Create;True;0;0;0;False;0;False;0.2;29.7;0;1000;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;262;-2662.638,673.6901;Float;False;Property;_SecondaryHighlightExponent;Secondary Highlight Exponent;26;0;Create;True;0;0;0;False;0;False;0.2;42.03;0;1000;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;327;-2427.24,-787.0815;Float;False;Property;_Variant_Color2_GlossA;Variant_Color2_Gloss(A);13;0;Create;True;0;0;0;False;0;False;0,0.1356491,0.7867647,0.516;0.2169809,0.1329193,0.1136078,0.2;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;326;-2428.317,-963.6812;Float;False;Property;_VariantColor1_GlossA;VariantColor1_Gloss(A);12;0;Create;True;0;0;0;False;0;False;0.8897059,0.1308391,0.1308391,0.516;0.2358491,0.1210285,0.09493292,0.2392157;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PowerNode;258;-2281.745,618.481;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;292;-1071.695,-941.9322;Float;False;Property;_TipColorPowerA;TipColor-Power(A);15;0;Create;True;0;0;0;False;0;False;0.9448277,1,0,0.484;0.1509432,0.09074713,0.07618355,0.3137255;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PowerNode;106;-2242,-30.08257;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;259;-2644.141,764.4827;Float;False;Property;_SecondaryHighlightStrength;Secondary Highlight Strength;25;0;Create;True;0;0;0;False;0;False;0.25;0.513;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;374;2206.926,458.8543;Inherit;True;Property;_ExtraCuttingR;ExtraCutting(R);30;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-2592.595,210.4834;Float;False;Property;_MainHighlightStrength;Main Highlight Strength;21;0;Create;True;0;0;0;False;0;False;0.25;1.277;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;446;425.184,-1707.961;Float;False;Property;_PushHairs_Bias;PushHairs_Bias;34;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;264;-2017.542,831.6193;Float;False;Property;_SecondaryHighlightColor;Secondary Highlight Color;23;0;Create;True;0;0;0;False;0;False;0.8862069,0.8862069,0.8862069,0;0.8113207,0.5147827,0.1122581,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;267;-2323.583,-261.4672;Float;False;Property;_MainHighlight_Color;MainHighlight_Color;19;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.517647,0.2274508,0.1607841,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LightColorNode;314;-1967.557,87.16968;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;429;411.1858,-2084.723;Float;False;Property;_PushHairs;PushHairs;33;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;414;2495.923,-1964.795;Inherit;False;1214.896;763.7308;Comment;24;448;452;449;450;455;451;408;411;399;413;424;453;456;29;389;459;461;462;464;467;468;469;454;457;FINAL OUTPUTs;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;389;2565.967,-1486.191;Inherit;False;388;OUTPUT_HairOpacity;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;457;2798.51,-1309.836;Inherit;False;Property;_DitherAmount;DitherAmount;36;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DitheringNode;454;2878.719,-1430.752;Inherit;False;1;True;3;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;341;-542.1967,1095.895;Inherit;False;2464.81;682.6744;ScatterLight;12;394;352;349;351;348;347;346;345;344;343;342;470;SSS;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;400;951.4557,-139.1102;Inherit;False;1945.699;360.5447;Comment;9;471;395;340;409;472;398;291;339;475;Emissive;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;482;1055.687,-420.6936;Inherit;False;1061;305;Apparently this helps;4;474;480;473;476;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;344;-491.3033,1182.426;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;408;2577.995,-1914.795;Inherit;False;407;OUTPUT_Albedo;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;340;1242.348,141.6602;Float;False;Property;_BaseIllumination;BaseIllumination;3;0;Create;True;0;0;0;False;0;False;0.15;0.408;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;399;2545.923,-1747.575;Inherit;False;398;OUTPUT_Emissive;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;348;-254.5041,1661.022;Float;False;Property;_Light_Scale;Light_Scale;1;0;Create;True;0;0;0;False;0;False;0;5.41;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;467;3420.398,-1919.026;Inherit;False;Lerp White To;-1;;11;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;394;1206.974,1307.55;Float;False;SSS_Effect;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;480;1749.687,-341.6936;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;411;2554.048,-1827.162;Inherit;False;410;OUTPUT_NormalMap;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ClampOpNode;470;1021.268,1304.485;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;351;455.8971,1451.844;Float;False;Property;_LightScatter;LightScatter;2;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;474;1954.687,-250.6936;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;347;-247.6851,1548.879;Float;False;Property;_Light_Bias;Light_Bias;0;0;Create;True;0;0;0;False;0;False;0;0.0435;0;0.1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;484;401.8126,876.1989;Inherit;False;OutNoise;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;349;487.6428,1298.705;Inherit;False;ConstantBiasScale;-1;;12;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;395;1015.946,83.30332;Inherit;False;394;SSS_Effect;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;476;1105.687,-370.6936;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TransformDirectionNode;343;-220.2491,1360.28;Inherit;False;Object;World;False;Fast;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;453;2882.446,-1626.141;Inherit;False;Property;_AlphaClipThreshold;AlphaClipThreshold;35;0;Create;True;0;0;0;False;0;False;0.5;0.473;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;472;1293.559,58.45184;Inherit;False;407;OUTPUT_Albedo;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;464;2949.398,-1726.026;Inherit;False;Property;_FakeOccPower;FakeOccPower;5;0;Create;True;0;0;0;False;0;False;0;1.38;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;456;3144.51,-1472.836;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;468;3254.398,-1790.026;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;342;-482.5477,1362.131;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;29;2547.708,-1654.873;Float;False;Property;_Metallic;Metallic;18;0;Create;True;0;0;0;False;0;False;0;0.62;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;413;2560.971,-1565.302;Inherit;False;412;OUTPUT_Smothness;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;424;2562.712,-1407.594;Inherit;False;423;OUTPUT_VertexMotion;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FresnelNode;473;1493.636,-355.5326;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;471;1643.924,7.443024;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;409;963.7852,-0.5117757;Inherit;False;407;OUTPUT_Albedo;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;475;1975.687,-58.6936;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;352;782.5613,1400.086;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;461;3236.398,-1920.026;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;459;2948.398,-1926.026;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;469;3269.398,-1646.026;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.NormalizeNode;345;46.99906,1350.441;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;462;2954.398,-1805.026;Inherit;False;Property;_FakeOccAdj;FakeOccAdj;4;0;Create;True;0;0;0;False;0;False;0;0.153;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;398;2490.614,4.566372;Float;False;OUTPUT_Emissive;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;448;3459.106,-1712.504;Float;False;True;-1;2;;0;2;RRF_HumanShaders/HairShader2/HairShader2_AS_RRF_VRTC_URP_2021;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;2;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;0;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;450;2942.537,-1783.504;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;451;2942.537,-1783.504;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;455;3291.537,-1726.504;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;452;2942.537,-1783.504;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;449;2942.537,-1783.504;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
WireConnection;365;0;364;0
WireConnection;365;1;458;0
WireConnection;403;0;335;4
WireConnection;316;0;365;0
WireConnection;315;0;316;0
WireConnection;7;3;485;0
WireConnection;7;4;485;0
